...
const QuotationPdfDocument = ({ quotation, businessProfile, palette, products, fontFamily = 'modern' }) => {
                ...
                <View style={styles.infoContainer}>
                    <View style={styles.infoBox}>
                        ...
                        <View style={styles.infoRow}>
                            ...
                            <Text style={styles.infoValue}>{safeStr(quotation.customerName)}</Text>
                        </View>
                        <View style={styles.infoRow}>
                            <Text style={styles.infoLabel}>Address:</Text>
                            <Text style={styles.infoValue}>{safeStr(quotation.address)}</Text>
                        </View>
                        <View style={styles.infoRow}>
                            <Text style={styles.infoLabel}>Phone:</Text>
                            <Text style={styles.infoValue}>{safeStr(quotation.phone)}</Text>
                        </View>
                        <View style={styles.infoRow}>
                            <Text style={styles.infoLabel}>WhatsApp:</Text>
                            <Text style={styles.infoValue}>{safeStr(quotation.whatsapp)}</Text>
                        </View>
                    </View>
                    ...
                    <View style={styles.infoBox}>
                        ...
                        <View style={styles.infoRow}>
                            ...
                            <Text style={styles.infoValue}>{safeStr(quotation.id)}</Text>
                        </View>
                        <View style={styles.infoRow}>
                            <Text style={styles.infoLabel}>Created:</Text>
                            <Text style={styles.infoValue}>{formatDate(quotation.createdDate)}</Text>
                        </View>
                        {quotation.expiryDate && (
                            <View style={styles.infoRow}>
                                <Text style={styles.infoLabel}>Valid Until:</Text>
                                <Text style={styles.infoValue}>{formatDate(quotation.expiryDate)}</Text>
                            </View>
                        )}
                        <View style={styles.infoRow}>
                            <Text style={styles.infoLabel}>Status:</Text>
                            <Text style={styles.infoValue}>{safeStr(quotation.status) || 'Draft'}</Text>
                        </View>
                    </View>
                </View>
